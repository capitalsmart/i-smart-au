...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify "><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="fa fa-cloud-upload"></i><span class='imageuploadify-message'>Drag & Drop Your File(s) Here To Upload</span><button type="button"class="btn btn-default">or select file to upload</button></div></div>`);
            ...
            const retrieveFiles = (files) => {
                ...
                if(files.length != 0 && opts.uploadLimit < (totalFiles.length + files.length)) {
                    isLimitExceeded = true;
                }
                else {
                    
                    if(files.length > opts.uploadLimit) {
                        isLimitExceeded = true;
                    }
                    else {
                        for (let index = 0; index < files.length; ++index) {
                            if (!accept || compareMimeType(result, files[index].type, /(?:\.([^.]+))?$/.exec(files[index].name)[1])) {
                                ...
                                if(totalFiles.length > opts.uploadLimit) {
                                    isLimitExceeded = true;
                                }
                                else {
	            ...
	            if(isLimitExceeded == true) {
                	alert('Upload limit exceeds. You can only upload '+opts.uploadLimit+' images.');
                }
            ...
            const readingFile = (id, file) => {
                ...
                deleteBtn.on("click", function(e) {
                    ...
                    $("#tr_photos [index="+index+"]").parent().remove();
