...
/*$allowed_domains = [
    'ec2-13-54-61-180.ap-southeast-2.compute.amazonaws.com',
    'i-smart.co.nz',
    'car-damage.dev.techarete.com'
];*/
...
$config['base_url'] = $protocol[ENVIRONMENT] . $domain;
...
/*
  ...
  'smtp_port' => 465,
  'smtp_user' => 'mueez@techarete.com', // change it to yours
  'smtp_pass' => 'abdul3211@@', // change it to yours
  'mailtype' => 'html',
  'charset' => 'iso-8859-1',
  'wordwrap' => TRUE
  ); */
